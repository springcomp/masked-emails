...
namespace WebApi.Services
{
    ...
    public class SQLiteProfilesService : IProfilesService
    {
        ...
        public SQLiteProfilesService(IMaskedEmailsDbContext context, IUniqueIdGenerator generator, IMaskedEmailCommandService commands, IOptions<AppSettings> settings)
        {
            context_ = context;
